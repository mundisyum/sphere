$(function(){
	...
	$("input[name=place]").val("test-test-test");
	...
	$.ajax({
		...
		error: function() { console.log("failed to load tracks.txt") }
	});
	...
	function ajaxingList2 () {
		...
		error: function() { console.log("failed to load tracks1.txt" ) }
		})
	}
	...
	function ajaxingList3 () {
		...
		error: function() { console.log("failed to load tracks3.txt" ) }
		})
	}
