...
// const { sendDataToGoogleSheets } = require("./index");

// module.exports = {
//   axios: require('axios'),
//   loginCredentials: JSON.parse(process.env.loginCredentials);
//   googleSheetWebAppUrl: process.env.googleSheetsWebhookUrl;
//   s3: new S3({
...
//     region: 'ru-1',
//   }),
//   handleApiRequests: async (usersData) => {
...
//     return res
//   },
//   sendDataToGoogleSheets: async (data) => {
...
//     }
//   },
//   updatePlaylist: async (options, updatedPlaylist) => {
//     try {
//       const { bucketName, playlistFolder, playlistFileName } = options
//       const params = {
//         Bucket: bucketName,
...
//     }
//   },
//   removeDislikedSongFromPlaylist: async (playlistFileName, dislikedSongName) => {
